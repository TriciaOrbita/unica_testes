    ...
    const fetchData = async () => {
      try {
        ...
        if (Array.isArray(data.combinedData)) {
          ...
          console.warn(
            "Os dados recebidos não são um array, definindo como array vazio.",
          );
          setPersonData([]);
        }
          ...
          <div className="flex items-center mb-6 mt-6 ml-4">
            ...
            <div>
              <h2 className="text-2xl font-bold ml-2">
                {displayPerson[" p.nom_pessoa"]}
              </h2>
              <p className="text-lg ml-2">
                Última atualização em {displayPerson[" d.dat_atual_fam"]}
              </p>
            </div>
          </div>
          <div className="p-6 max-w-md mx-auto bg-white rounded-lg shadow-md">
            {[
              ...
              },
              {
                label: "Idade",
                value: displayPerson[" p.dta_nasc_pessoa"]
                  ? `${calculateAge(displayPerson[" p.dta_nasc_pessoa"])} anos`
                  : "-",
              },
              {
                label: "CadÚnico",
              ...
              },
              {
                label: "Sexo",
                value:
                  displayPerson[" p.cod_sexo_pessoa"] === "1"
                    ? "Masculino"
                    : displayPerson[" p.cod_sexo_pessoa"] === "2"
                      ? "Feminino"
                      : "-",
              },
              {
              ...
              },
              {
                ...
                value:
                  displayPerson[" p.marc_sit_rua"] === "0"
                    ? "Não está em situação de rua"
                    : displayPerson[" p.marc_sit_rua"] === "1"
